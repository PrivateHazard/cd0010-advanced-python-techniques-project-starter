...
class NearEarthObject:
    ...
    def __str__(self):
        """Return `str(self)`."""
        return f"NEO: {self.designation}, Name: {self.name}, Diameter: {self.diameter}, Hazardous: {self.hazardous}"
...
class CloseApproach:
    ...
    `NEODatabase` constructor.
    """
    def __init__(self, _designation, time=None, distance=float(0.0), velocity=float(0.0), neo=None):
        """Create a new `CloseApproach`.

        :param _designation: The primary designation for the close approach NEO.
    ...
    def __str__(self):
        """Return `str(self)`."""
        return f"Time: {self.time}, Distance: {self.distance}, Velocity: {self.velocity}"
